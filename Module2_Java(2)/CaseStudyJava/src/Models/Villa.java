...
public class Villa extends Services {
    ...
    public Villa(String id, String nameService, double area, double rentCost, int maxNumberOfPeople, String typeRent, String roomStandard, String description, double poolArea, int floor) {
