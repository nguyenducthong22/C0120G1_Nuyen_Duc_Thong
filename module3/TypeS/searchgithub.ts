...
async function fetchRepo(): Promise<Array<ISingleRepo>> {
    let res: Response | IRepos = await fetch('https://api.github.com/search/repositories?q=C01');
...
async function main() {
    ...
    // step 3: call hàm cretscateItem sau đó truyền vào name của từng item ở mỗi vòng lặp
